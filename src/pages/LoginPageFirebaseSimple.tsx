...
interface LoginPageFirebaseSimpleProps {
  onSignIn: (email: string, password: string) => Promise<void>
}

const LoginPageFirebaseSimple: React.FC<LoginPageFirebaseSimpleProps> = ({ onSignIn }) => {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-1 text-center text-xs text-gray-500 english">
        ...
        <div className="text-center">
          ...
          <div className="mt-4 p-3 bg-blue-50 rounded-md">
            <p className="text-xs text-blue-800 arabic font-medium mb-2">بيانات تجريبية:</p>
...
export default LoginPageFirebaseSimple
