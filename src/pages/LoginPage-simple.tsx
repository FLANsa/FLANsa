  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      if (email === 'admin@bigdiet.com' && password === 'password123') {
        alert('Login successful! Welcome to Big Diet POS')
        setLoading(false)
      } else {
        setError('Invalid credentials. Use admin@bigdiet.com / password123')
        setLoading(false)
      }
    }, 1000)
  }
      ...
      <div className="max-w-md w-full space-y-8">
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  className="appearance-none rounded-md relative block w-full px-3 py-2 pr-10 pl-10 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-primary-500 focus:border-primary-500 focus:z-10 sm:text-sm"
        ...
        <div className="text-center">
          ...
          <p className="text-xs text-blue-600 mt-2">
            Demo: admin@bigdiet.com / password123
          </p>
        </div>
      </div>
    </div>
