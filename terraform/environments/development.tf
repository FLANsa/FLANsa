...
variable "cluster_name" {
  ...
  type        = string
  default     = "qayd-pos-dev-cluster"
}

variable "node_group_name" {
  description = "EKS node group name"
  type        = string
  default     = "qayd-pos-dev-nodes"
}
...
variable "ingress_domain" {
  ...
  type        = string
  default     = "qayd-pos-dev.example.com"
}
...
variable "cloudtrail_log_group" {
  ...
  type        = string
  default     = "qayd-pos-dev-cloudtrail"
}
...
variable "inspector_assessment_target" {
  ...
  type        = string
  default     = "qayd-pos-dev-assessment-target"
}
...
variable "iam_access_analyzer_analyzer_name" {
  ...
  type        = string
  default     = "qayd-pos-dev-iam-analyzer"
}
...
variable "mfa_policy_name" {
  ...
  type        = string
  default     = "qayd-pos-dev-mfa-policy"
}
...
variable "organization_policy_name" {
  ...
  type        = string
  default     = "qayd-pos-dev-organization-policy"
}

variable "organization_policy_description" {
  description = "Organization policy description"
  type        = string
  default     = "Qayd POS Development Organization Policy"
}
...
variable "cost_anomaly_detection_monitor_name" {
  ...
  type        = string
  default     = "qayd-pos-dev-cost-monitor"
}
