...
variable "cluster_name" {
  ...
  type        = string
  default     = "qayd-pos-staging-cluster"
}

variable "node_group_name" {
  description = "EKS node group name"
  type        = string
  default     = "qayd-pos-staging-nodes"
}
...
variable "ingress_domain" {
  ...
  type        = string
  default     = "qayd-pos-staging.example.com"
}
...
variable "cloudtrail_log_group" {
  ...
  type        = string
  default     = "qayd-pos-staging-cloudtrail"
}
...
variable "inspector_assessment_target" {
  ...
  type        = string
  default     = "qayd-pos-staging-assessment-target"
}
...
variable "access_analyzer_analyzer_name" {
  ...
  type        = string
  default     = "qayd-pos-staging-analyzer"
}
...
variable "iam_access_analyzer_analyzer_name" {
  ...
  type        = string
  default     = "qayd-pos-staging-iam-analyzer"
}
...
variable "mfa_policy_name" {
  ...
  type        = string
  default     = "qayd-pos-staging-mfa-policy"
}
...
variable "organization_policy_name" {
  ...
  type        = string
  default     = "qayd-pos-staging-organization-policy"
}
...
variable "cost_anomaly_detection_monitor_name" {
  ...
  type        = string
  default     = "qayd-pos-staging-cost-monitor"
}
