# Terraform variables for Qayd POS System
...
variable "inspector_assessment_target" {
  ...
  type        = string
  default     = "qayd-pos-assessment-target"
}
...
variable "organization_policy_name" {
  ...
  type        = string
  default     = "qayd-pos-organization-policy"
}
